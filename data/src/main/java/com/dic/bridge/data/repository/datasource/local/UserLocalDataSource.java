package com.dic.bridge.data.repository.datasource.local;

import com.dic.bridge.base.manager.database.DBManager;
import com.dic.bridge.data.base.SourceCallback;
import com.dic.bridge.data.cache.database.dao.UserModelDao;
